...
const CampaignForm: React.FC<CampaignFormProps>= ( {onSubmit, onCancel}) => {
    ...
    return (
        ...
        <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="campaign-form campaign-button submit">Stwórz kampanię</button>
            <button onClick={onCancel} type="button" className="campaign-form campaign-button cancel">Anuluj</button>
        </form>
        </>
    )   
}
