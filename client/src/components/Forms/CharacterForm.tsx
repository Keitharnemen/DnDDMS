  ...
  const handleRaceChange = (newRaceId: number) => {
    ...
    setForm((prev) => {
      ...
      const updatedForm = {
        ...
        inteligence:
          prev.inteligence - oldRace!.inteligence + newRace!.inteligence,
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="chRace-wrapper">
          ...
          <select
            ...
            value={form.raceId}
            onChange={(event) =>
              !character ? handleRaceChange(Number(event.target.value)) : {}
            }
            required
          >
        ...
        <div className="chClass-wrapper">
          ...
          <select
            ...
            value={form.classId}
            onChange={(event) =>
              !character ? handleClassChange(Number(event.target.value)) : {}
            }
            required
          >
            <option value={0} disabled>
        ...
        <div className="chDexterity-wrapper">
          ...
          <input
            ...
            onChange={(event) =>
              setForm((prev) => ({
                ...prev,
                dexterity: Number(event.target.value),
              }))
            }
            min={min}
            step={1}
        ...
        <div className="chConstitution-wrapper">
          ...
          <input
            ...
            onChange={(event) =>
              handleConstitutionChange(Number(event.target.value))
            }
        ...
        <div className="chWisdom-wrapper">
          ...
          <input
            ...
            onChange={(event) =>
              setForm((prev) => ({
                ...prev,
                wisdom: Number(event.target.value),
              }))
            }
            min={min}
            step={1}
        ...
        <div className="chInteligence-wrapper">
          ...
          <input
            ...
            onChange={(event) =>
              setForm((prev) => ({
                ...prev,
                inteligence: Number(event.target.value),
              }))
            }
            min={min}
            step={1}
        ...
        <div className="chCharisma-wrapper">
          ...
          <input
            ...
            onChange={(event) =>
              setForm((prev) => ({
                ...prev,
                charisma: Number(event.target.value),
              }))
            }
            min={min}
            step={1}
